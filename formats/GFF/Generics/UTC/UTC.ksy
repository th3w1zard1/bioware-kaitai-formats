meta:
  id: gff_utc
  title: BioWare GFF3 UTC (UTC template)
  license: MIT
  endian: le
  file-extension: utc
  imports:
  ...
  xref:
    ...
    xoreos_file_type_id_value: |
      Numeric id 2027 (`xoreos_file_type_id` in `formats/Common/bioware_type_ids.ksy`).
...
seq:
  - id: contents
    ...
    doc: Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per UTC template docs / PyKotor `gff_auto`.
