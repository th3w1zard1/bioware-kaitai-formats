meta:
  id: gff_cut
  title: BioWare GFF3 CUT (CUT template)
  license: MIT
  endian: le
  file-extension: cut
  imports:
  ...
  xref:
    ...
    xoreos_file_type_id_value: |
      Numeric id 2074 (`xoreos_file_type_id` in `formats/Common/bioware_type_ids.ksy`).
...
seq:
  - id: contents
    ...
    doc: Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per CUT template docs / PyKotor `gff_auto`.
