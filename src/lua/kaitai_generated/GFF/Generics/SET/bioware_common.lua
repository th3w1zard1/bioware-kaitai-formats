...
-- See also: PyKotor — Language (substring language IDs) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/common/language.py)
-- See also: PyKotor — Gender / Game / EquipmentSlot (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/common/misc.py)
-- See also: PyKotor — ObjectType (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/common/game_object.py)
-- See also: PyKotor — GFF field read path (LocalizedString via reader) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/gff/io_gff.py#L220-L235)
-- See also: xoreos — `Language` / `LanguageGender` (Aurora runtime; compare TLK / substring packing) (https://github.com/xoreos/xoreos/blob/master/src/aurora/language.h#L46-L73)
-- See also: xoreos — `TalkTable_TLK::load` (TLK header + language id field) (https://github.com/xoreos/xoreos/blob/master/src/aurora/talktable_tlk.cpp#L57-L92)
-- See also: xoreos-tools — `byte` / `uint` typedefs (https://github.com/xoreos/xoreos-tools/blob/master/src/common/types.h#L28-L33)
-- See also: reone — resource type / engine constants (https://github.com/modawan/reone/blob/master/include/reone/resource/types.h)
-- See also: xoreos-docs — BioWare specs PDF tree (discoverability) (https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware)
