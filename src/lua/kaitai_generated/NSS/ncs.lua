...
-- See also: PyKotor wiki — NCS (https://github.com/OpenKotOR/PyKotor/wiki/NCS-File-Format)
-- See also: PyKotor — compiled script load path (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ncs/io_ncs.py#L60-L90)
-- See also: xoreos — NCSFile::load (https://github.com/xoreos/xoreos/blob/master/src/aurora/nwscript/ncsfile.cpp#L333-L355)
-- See also: xoreos-tools — NCSFile::load (https://github.com/xoreos/xoreos-tools/blob/master/src/nwscript/ncsfile.cpp#L106-L137)
-- See also: xoreos-docs — Torlack ncs.html (https://github.com/xoreos/xoreos-docs/blob/master/specs/torlack/ncs.html)
-- See also: reone — NcsReader::load (https://github.com/modawan/reone/blob/master/src/libs/script/format/ncsreader.cpp#L28-L40)
-- See also: PyKotor — NCSByteCode / NCSInstructionQualifier (shared .ksy enums) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ncs/ncs_data.py#L69-L140)
...
function Ncs.Instruction:_read()
  self.opcode = BiowareNcsCommon.NcsBytecode(self._io:read_u1())
  self.qualifier = BiowareNcsCommon.NcsInstructionQualifier(self._io:read_u1())
  self.arguments = {}
  local i = 0
  while true do
