...
-- See also: PyKotor — `io_ltr` reader/writer (start of `write`) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ltr/io_ltr.py#L44-L155)
-- See also: xoreos — `kFileTypeLTR` (https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L101)
-- See also: xoreos — `LTRFile::readLetterSet` (https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L121-L133)
-- See also: xoreos — `LTRFile::load` (https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L135-L168)
-- See also: reone — `LtrReader::load` + `readLetterSet` (https://github.com/modawan/reone/blob/master/src/libs/resource/format/ltrreader.cpp#L27-L74)
-- See also: KotOR.js — `LTRObject.readBuffer` (https://github.com/KobaltBlu/KotOR.js/blob/master/src/resource/LTRObject.ts#L51-L122)
-- See also: xoreos-docs — BioWare specs tree (no dedicated LTR Torlack page; use `ltrfile.cpp` + PyKotor) (https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware)
