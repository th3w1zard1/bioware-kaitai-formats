...
-- See also: xoreos-tools — shipped CLI inventory (no BWM-specific tool) (https://github.com/xoreos/xoreos-tools/blob/master/README.md#L17-L43)
-- See also: PyKotor wiki — BWM (https://github.com/OpenKotOR/PyKotor/wiki/Level-Layout-Formats#bwm)
-- See also: PyKotor — Kaitai-backed BWM struct load (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/bwm/io_bwm.py#L56-L110)
-- See also: PyKotor — BWMBinaryReader.load (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/bwm/io_bwm.py#L187-L253)
-- See also: xoreos — WalkmeshLoader::load (https://github.com/xoreos/xoreos/blob/master/src/engines/kotorbase/path/walkmeshloader.cpp#L42-L113)
-- See also: xoreos — WalkmeshLoader (append tables / WOK-only paths) (https://github.com/xoreos/xoreos/blob/master/src/engines/kotorbase/path/walkmeshloader.cpp#L119-L216)
-- See also: xoreos — WalkmeshLoader::getAABB (https://github.com/xoreos/xoreos/blob/master/src/engines/kotorbase/path/walkmeshloader.cpp#L218-L249)
-- See also: reone — BwmReader::load (https://github.com/modawan/reone/blob/master/src/libs/graphics/format/bwmreader.cpp#L27-L92)
-- See also: reone — BwmReader (AABB / adjacency tables) (https://github.com/modawan/reone/blob/master/src/libs/graphics/format/bwmreader.cpp#L94-L171)
-- See also: KotOR.js — readBinary (https://github.com/KobaltBlu/KotOR.js/blob/master/src/odyssey/OdysseyWalkMesh.ts#L301-L395)
-- See also: KotOR.js — header / version constants (https://github.com/KobaltBlu/KotOR.js/blob/master/src/odyssey/OdysseyWalkMesh.ts#L490-L516)
-- See also: xoreos-docs — BioWare specs tree (no dedicated BWM / walkmesh Torlack page; use engine + PyKotor xrefs above) (https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware)
