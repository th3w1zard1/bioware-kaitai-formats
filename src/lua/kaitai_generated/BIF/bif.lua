...
-- See also: PyKotor — `io_bif` (Kaitai + legacy + reader) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/bif/io_bif.py#L57-L215)
-- See also: PyKotor — `BIFType` (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/bif/bif_data.py#L59-L71)
-- See also: xoreos — `BIFFile::load` + `readVarResTable` (https://github.com/xoreos/xoreos/blob/master/src/aurora/biffile.cpp#L54-L97)
-- See also: xoreos — `kFileTypeBIF` (https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L208)
-- See also: xoreos-tools — `unkeybif` (non-`.bzf` → `BIFFile`) (https://github.com/xoreos/xoreos-tools/blob/master/src/unkeybif.cpp#L206-L209)
-- See also: reone — `BifReader` (https://github.com/modawan/reone/blob/master/src/libs/resource/format/bifreader.cpp#L26-L63)
-- See also: KotOR.js — `BIFObject` (https://github.com/KobaltBlu/KotOR.js/blob/master/src/resource/BIFObject.ts)
-- See also: xoreos-docs — Torlack bif.html (https://github.com/xoreos/xoreos-docs/blob/master/specs/torlack/bif.html)
