...
-- See also: PyKotor wiki — SSF (https://github.com/OpenKotOR/PyKotor/wiki/Audio-and-Localization-Formats#ssf)
-- See also: PyKotor — `io_ssf` (Kaitai bridge + binary read/write) (https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ssf/io_ssf.py#L102-L166)
-- See also: xoreos — `kFileTypeSSF` (https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L126)
-- See also: xoreos — `SSFFile::load` + `readSSFHeader` + `readEntries` (https://github.com/xoreos/xoreos/blob/master/src/aurora/ssffile.cpp#L72-L141)
-- See also: xoreos — `readEntriesKotOR` (https://github.com/xoreos/xoreos/blob/master/src/aurora/ssffile.cpp#L165-L170)
-- See also: xoreos-tools — `ssf2xml` CLI (https://github.com/xoreos/xoreos-tools/blob/master/src/ssf2xml.cpp#L51-L70)
-- See also: xoreos-tools — `xml2ssf` CLI (`main`) (https://github.com/xoreos/xoreos-tools/blob/master/src/xml2ssf.cpp#L54-L75)
-- See also: xoreos-tools — `SSFDumper::dump` (XML mapping for `ssf2xml`) (https://github.com/xoreos/xoreos-tools/blob/master/src/xml/ssfdumper.cpp#L133-L167)
-- See also: xoreos-tools — `SSFCreator::create` (XML mapping for `xml2ssf`) (https://github.com/xoreos/xoreos-tools/blob/master/src/xml/ssfcreator.cpp#L38-L74)
-- See also: xoreos-docs — SSF_Format.pdf (https://github.com/xoreos/xoreos-docs/blob/master/specs/bioware/SSF_Format.pdf)
-- See also: reone — `SsfReader::load` (https://github.com/modawan/reone/blob/master/src/libs/resource/format/ssfreader.cpp#L26-L32)
