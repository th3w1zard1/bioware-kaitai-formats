...
namespace {
    class Das extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\Das $_root = null) {
        ...
        private function _read() {
            ...
            if (!($this->_m_signature == "DAS ")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("DAS ", $this->_m_signature, $this->_io, "/seq/0");
            }
            ...
            $this->_m_saveName = new \Das\LengthPrefixedString($this->_io, $this, $this->_root);
            $this->_m_moduleName = new \Das\LengthPrefixedString($this->_io, $this, $this->_root);
            $this->_m_areaName = new \Das\LengthPrefixedString($this->_io, $this, $this->_root);
            ...
            $this->_m_playerName = new \Das\LengthPrefixedString($this->_io, $this, $this->_root);
...
namespace Das {
    class LengthPrefixedString extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Das $_parent = null, ?\Das $_root = null) {
