    ...
    class Mdl extends \Kaitai\Struct\Struct {
        ...
        public function animations() {
            ...
            if ($this->modelHeader()->animationCount() > 0) {
                ...
                $n = $this->modelHeader()->animationCount();
                for ($i = 0; $i < $n; $i++) {
                    $this->_m_animations[] = new \Mdl\AnimationHeader($this->_io, $this, $this->_root);
                }
                $this->_io->seek($_pos);
            }
            return $this->_m_animations;
...
namespace Mdl {
    class ControllerType {
        ...
        private const _VALUES = [8 => true, 20 => true, 36 => true, 76 => true, 88 => true, 96 => true, 100 => true, 132 => true, 140 => true];
