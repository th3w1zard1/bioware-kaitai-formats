...
type
  MdlAscii* = ref object of KaitaiStruct
    ...
    `parent`*: KaitaiStruct
  MdlAscii_ControllerTypeCommon* = enum
    position = 8
    orientation = 20
    scale = 36
    alpha = 132
  MdlAscii_ControllerTypeEmitter* = enum
    alpha_end = 80
    alpha_start = 84
    birthrate = 88
    bounce_co = 92
    ...
    color_start = 392
    detonate = 502
  MdlAscii_ControllerTypeLight* = enum
    color = 76
    radius = 88
    shadowradius = 96
    verticaldisplacement = 100
    multiplier = 140
  MdlAscii_ControllerTypeMesh* = enum
    selfillumcolor = 100
  MdlAscii_ModelClassification* = enum
    other = 0
    effect = 1
    tile = 2
    character = 4
