...
type
  GffUtm* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffUtm], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtm
...
proc read*(_: typedesc[GffUtm], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtm =
  ...
  this = new(GffUtm)
  let root = if root == nil: cast[GffUtm](this) else: cast[GffUtm](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffUtm], filename: string): GffUtm =
  GffUtm.read(newKaitaiFileStream(filename), nil, nil)
