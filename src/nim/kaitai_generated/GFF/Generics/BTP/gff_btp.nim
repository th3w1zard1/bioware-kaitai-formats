...
type
  GffBtp* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffBtp], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtp
...
proc read*(_: typedesc[GffBtp], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtp =
  ...
  this = new(GffBtp)
  let root = if root == nil: cast[GffBtp](this) else: cast[GffBtp](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffBtp], filename: string): GffBtp =
  GffBtp.read(newKaitaiFileStream(filename), nil, nil)
