...
type
  GffIfo* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffIfo], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffIfo
...
proc read*(_: typedesc[GffIfo], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffIfo =
  ...
  this = new(GffIfo)
  let root = if root == nil: cast[GffIfo](this) else: cast[GffIfo](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffIfo], filename: string): GffIfo =
  GffIfo.read(newKaitaiFileStream(filename), nil, nil)
