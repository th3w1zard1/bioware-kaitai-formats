...
type
  GffUte* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffUte], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUte
...
proc read*(_: typedesc[GffUte], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUte =
  ...
  this = new(GffUte)
  let root = if root == nil: cast[GffUte](this) else: cast[GffUte](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffUte], filename: string): GffUte =
  GffUte.read(newKaitaiFileStream(filename), nil, nil)
