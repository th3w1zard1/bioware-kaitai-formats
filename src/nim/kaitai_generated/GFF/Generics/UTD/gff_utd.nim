...
type
  GffUtd* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffUtd], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtd
...
proc read*(_: typedesc[GffUtd], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtd =
  ...
  this = new(GffUtd)
  let root = if root == nil: cast[GffUtd](this) else: cast[GffUtd](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffUtd], filename: string): GffUtd =
  GffUtd.read(newKaitaiFileStream(filename), nil, nil)
