...
type
  GffBtg* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffBtg], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtg
...
proc read*(_: typedesc[GffBtg], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtg =
  ...
  this = new(GffBtg)
  let root = if root == nil: cast[GffBtg](this) else: cast[GffBtg](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffBtg], filename: string): GffBtg =
  GffBtg.read(newKaitaiFileStream(filename), nil, nil)
