...
type
  GffItp* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffItp], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffItp
...
proc read*(_: typedesc[GffItp], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffItp =
  ...
  this = new(GffItp)
  let root = if root == nil: cast[GffItp](this) else: cast[GffItp](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffItp], filename: string): GffItp =
  GffItp.read(newKaitaiFileStream(filename), nil, nil)
