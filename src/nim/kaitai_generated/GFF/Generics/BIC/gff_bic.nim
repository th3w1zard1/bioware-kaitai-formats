...
type
  GffBic* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffBic], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBic
...
proc read*(_: typedesc[GffBic], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBic =
  ...
  this = new(GffBic)
  let root = if root == nil: cast[GffBic](this) else: cast[GffBic](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffBic], filename: string): GffBic =
  GffBic.read(newKaitaiFileStream(filename), nil, nil)
