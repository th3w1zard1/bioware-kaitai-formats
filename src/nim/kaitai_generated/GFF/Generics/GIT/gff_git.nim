...
type
  GffGit* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffGit], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffGit
...
proc read*(_: typedesc[GffGit], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffGit =
  ...
  this = new(GffGit)
  let root = if root == nil: cast[GffGit](this) else: cast[GffGit](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffGit], filename: string): GffGit =
  GffGit.read(newKaitaiFileStream(filename), nil, nil)
