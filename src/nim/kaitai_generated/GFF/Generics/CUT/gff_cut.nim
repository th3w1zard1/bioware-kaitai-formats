...
type
  GffCut* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffCut], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffCut
...
proc read*(_: typedesc[GffCut], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffCut =
  ...
  this = new(GffCut)
  let root = if root == nil: cast[GffCut](this) else: cast[GffCut](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffCut], filename: string): GffCut =
  GffCut.read(newKaitaiFileStream(filename), nil, nil)
