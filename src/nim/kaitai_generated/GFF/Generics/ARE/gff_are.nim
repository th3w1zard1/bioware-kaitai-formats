...
type
  GffAre* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffAre], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffAre
...
proc read*(_: typedesc[GffAre], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffAre =
  ...
  this = new(GffAre)
  let root = if root == nil: cast[GffAre](this) else: cast[GffAre](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffAre], filename: string): GffAre =
  GffAre.read(newKaitaiFileStream(filename), nil, nil)
