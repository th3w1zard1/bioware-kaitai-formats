...
type
  GffSav* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffSav], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffSav
...
proc read*(_: typedesc[GffSav], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffSav =
  ...
  this = new(GffSav)
  let root = if root == nil: cast[GffSav](this) else: cast[GffSav](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffSav], filename: string): GffSav =
  GffSav.read(newKaitaiFileStream(filename), nil, nil)
