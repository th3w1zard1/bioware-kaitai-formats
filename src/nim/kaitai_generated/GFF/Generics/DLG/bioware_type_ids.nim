...
type
  BiowareTypeIds* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  BiowareTypeIds_BiowareResourceTypeId* = enum
    invalid = -1
    res = 0
    bmp = 1
    mve = 2
    ...
    lip_json = 50028
    res_xml = 50029
  BiowareTypeIds_XoreosArchiveType* = enum
    key = 0
    bif = 1
    erf = 2
    rim = 3
    ...
    nsbtx = 8
    max = 9
  BiowareTypeIds_XoreosFileTypeId* = enum
    none = -1
    res = 0
    bmp = 1
    mve = 2
    ...
    xeositex = 40000
    wbm = 41000
  BiowareTypeIds_XoreosGameId* = enum
    unknown = -1
    nwn = 0
    nwn2 = 1
    kotor = 2
    ...
    dragon_age2 = 8
    max = 9
  BiowareTypeIds_XoreosPlatformId* = enum
    windows = 0
    mac_osx = 1
    linux = 2
    xbox = 3
    ...
    ios = 8
    unknown = 9
  BiowareTypeIds_XoreosResourceCategory* = enum
    image = 0
    video = 1
    sound = 2
    music = 3
...
proc read*(_: typedesc[BiowareTypeIds], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): BiowareTypeIds
...
proc read*(_: typedesc[BiowareTypeIds], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): BiowareTypeIds =
  ...
  this = new(BiowareTypeIds)
  let root = if root == nil: cast[BiowareTypeIds](this) else: cast[BiowareTypeIds](root)
  this.io = io
  this.root = root
  this.parent = parent


proc fromFile*(_: typedesc[BiowareTypeIds], filename: string): BiowareTypeIds =
  BiowareTypeIds.read(newKaitaiFileStream(filename), nil, nil)
