...
type
  GffJrl* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffJrl], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffJrl
...
proc read*(_: typedesc[GffJrl], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffJrl =
  ...
  this = new(GffJrl)
  let root = if root == nil: cast[GffJrl](this) else: cast[GffJrl](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffJrl], filename: string): GffJrl =
  GffJrl.read(newKaitaiFileStream(filename), nil, nil)
