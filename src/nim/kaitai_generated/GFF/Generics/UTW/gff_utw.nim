...
type
  GffUtw* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffUtw], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtw
...
proc read*(_: typedesc[GffUtw], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffUtw =
  ...
  this = new(GffUtw)
  let root = if root == nil: cast[GffUtw](this) else: cast[GffUtw](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffUtw], filename: string): GffUtw =
  GffUtw.read(newKaitaiFileStream(filename), nil, nil)
