...
type
  GffBtm* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffBtm], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtm
...
proc read*(_: typedesc[GffBtm], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtm =
  ...
  this = new(GffBtm)
  let root = if root == nil: cast[GffBtm](this) else: cast[GffBtm](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffBtm], filename: string): GffBtm =
  GffBtm.read(newKaitaiFileStream(filename), nil, nil)
