...
type
  GffPtt* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffPtt], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffPtt
...
proc read*(_: typedesc[GffPtt], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffPtt =
  ...
  this = new(GffPtt)
  let root = if root == nil: cast[GffPtt](this) else: cast[GffPtt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffPtt], filename: string): GffPtt =
  GffPtt.read(newKaitaiFileStream(filename), nil, nil)
