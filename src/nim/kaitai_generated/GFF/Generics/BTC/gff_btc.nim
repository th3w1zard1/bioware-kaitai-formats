...
type
  GffBtc* = ref object of KaitaiStruct
    `contents`*: Gff_GffUnionFile
    `parent`*: KaitaiStruct

proc read*(_: typedesc[GffBtc], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtc
...
proc read*(_: typedesc[GffBtc], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): GffBtc =
  ...
  this = new(GffBtc)
  let root = if root == nil: cast[GffBtc](this) else: cast[GffBtc](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[GffBtc], filename: string): GffBtc =
  GffBtc.read(newKaitaiFileStream(filename), nil, nil)
