 ...
 * @see {@link https://github.com/OpenKotOR/PyKotor/wiki/Texture-Formats#kotor-plt-file-format-documentation-nwn-legacy|PyKotor wiki — PLT (NWN legacy)}
 * @see {@link https://github.com/xoreos/xoreos-docs/blob/master/specs/torlack/plt.html|xoreos-docs — Torlack plt.html}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/graphics/aurora/pltfile.cpp#L102-L145|xoreos — `PLTFile::load`}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L63|xoreos — `kFileTypePLT`}
 * @see {@link https://github.com/modawan/reone/blob/master/include/reone/resource/types.h#L35|reone — `ResourceType::Plt` (id 6; no `.plt` wire reader on default branch)}
 */
