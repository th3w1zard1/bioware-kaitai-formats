 ...
 * @see {@link https://github.com/OpenKotOR/PyKotor/wiki/Audio-and-Localization-Formats#ssf|PyKotor wiki — SSF}
 * @see {@link https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ssf/io_ssf.py#L102-L166|PyKotor — `io_ssf` (Kaitai bridge + binary read/write)}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L126|xoreos — `kFileTypeSSF`}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/ssffile.cpp#L72-L141|xoreos — `SSFFile::load` + `readSSFHeader` + `readEntries`}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/ssffile.cpp#L165-L170|xoreos — `readEntriesKotOR`}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/ssf2xml.cpp#L51-L70|xoreos-tools — `ssf2xml` CLI}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/xml2ssf.cpp#L54-L75|xoreos-tools — `xml2ssf` CLI (`main`)}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/xml/ssfdumper.cpp#L133-L167|xoreos-tools — `SSFDumper::dump` (XML mapping for `ssf2xml`)}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/xml/ssfcreator.cpp#L38-L74|xoreos-tools — `SSFCreator::create` (XML mapping for `xml2ssf`)}
 * @see {@link https://github.com/xoreos/xoreos-docs/blob/master/specs/bioware/SSF_Format.pdf|xoreos-docs — SSF_Format.pdf}
 * @see {@link https://github.com/modawan/reone/blob/master/src/libs/resource/format/ssfreader.cpp#L26-L32|reone — `SsfReader::load`}
 */
