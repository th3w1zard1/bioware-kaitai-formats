 ...
 * @see {@link https://github.com/OpenKotOR/PyKotor/wiki/2DA-File-Format|PyKotor wiki — TwoDA}
 * @see {@link https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/twoda/io_twoda.py#L25-L238|PyKotor — `io_twoda` (binary `V2.b` + writer)}
 * @see {@link https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/twoda/twoda_data.py#L8-L114|PyKotor — `twoda_data` (model + ASCII/binary notes)}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/2dafile.cpp#L48-L51|xoreos — `k2DAID` / `k2DAIDTab` + version tags}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/2dafile.cpp#L145-L172|xoreos — `TwoDAFile::load`}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/2dafile.cpp#L192-L336|xoreos — binary `V2.b` (`read2b` + `readHeaders2b` / `skipRowNames2b` / `readRows2b`)}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/2dafile.cpp#L517-L611|xoreos — `TwoDAFile::writeBinary`}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/convert2da.cpp#L64-L86|xoreos-tools — `convert2da` CLI (`main`)}
 * @see {@link https://github.com/xoreos/xoreos-tools/blob/master/src/convert2da.cpp#L143-L159|xoreos-tools — `get2DAGDA` / `TwoDAFile` dispatch}
 * @see {@link https://github.com/modawan/reone/blob/master/src/libs/resource/format/2dareader.cpp#L29-L66|reone — `TwoDAReader`}
 * @see {@link https://github.com/KobaltBlu/KotOR.js/blob/master/src/resource/TwoDAObject.ts#L69-L155|KotOR.js — `TwoDAObject`}
 * @see {@link https://github.com/xoreos/xoreos-docs/blob/master/specs/bioware/2DA_Format.pdf|xoreos-docs — 2DA_Format.pdf}
 */
