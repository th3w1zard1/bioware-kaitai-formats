...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Mdl || (root.Mdl = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Mdl_, KaitaiStream) {
/**
 ...
 * @see {@link https://github.com/OpenKotOR/PyKotor/wiki/MDL-MDX-File-Format|Source}
 */

var Mdl = (function() {
  Mdl.ControllerType = Object.freeze({
    POSITION: 8,
    ORIENTATION: 20,
    SCALE: 36,
    COLOR: 76,
  ...
  Mdl.ModelClassification = Object.freeze({
    OTHER: 0,
    EFFECT: 1,
    TILE: 2,
    CHARACTER: 4,
  ...
  Mdl.NodeTypeValue = Object.freeze({
    DUMMY: 1,
    LIGHT: 3,
    EMITTER: 5,
    REFERENCE: 17,
