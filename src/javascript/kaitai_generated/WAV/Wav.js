 ...
 * @see {@link https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/wav/io_wav.py#L43-L187|PyKotor — `io_wav` (Kaitai RIFF parse + `WAVBinaryReader.load` + legacy)}
 * @see {@link https://github.com/modawan/reone/blob/master/src/libs/audio/format/wavreader.cpp#L30-L72|reone — `WavReader` (fake header + chunk loop)}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/sound/decoders/wave.cpp#L38-L106|xoreos — `makeWAVStream` / chunk scan}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/sound/sound.cpp#L256-L340|xoreos — `SoundManager::makeAudioStream` KotOR WAVE quirks}
 * @see {@link https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L62|xoreos — `kFileTypeWAV` (numeric id)}
 * @see {@link https://github.com/KobaltBlu/KotOR.js/blob/master/src/audio/AudioFile.ts#L10-L145|KotOR.js — `AudioFile` (prefix + MP3-in-WAV)}
 * @see {@link https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware|xoreos-docs — BioWare specs PDF tree (no dedicated WAV PDF; discoverability anchor)}
 */
