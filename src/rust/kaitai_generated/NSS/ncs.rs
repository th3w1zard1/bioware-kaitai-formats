...
use std::rc::{Rc, Weak};
use super::bioware_ncs_common::BiowareNcsCommon_NcsBytecode;
use super::bioware_ncs_common::BiowareNcsCommon_NcsInstructionQualifier;
...
pub struct Ncs_Instruction {
    ...
    pub _parent: SharedType<Ncs>,
    pub _self: SharedType<Self>,
    opcode: RefCell<BiowareNcsCommon_NcsBytecode>,
    qualifier: RefCell<BiowareNcsCommon_NcsInstructionQualifier>,
...
impl KStruct for Ncs_Instruction {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.qualifier.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
 ...
 */
impl Ncs_Instruction {
    pub fn opcode(&self) -> Ref<'_, BiowareNcsCommon_NcsBytecode> {
        self.opcode.borrow()
    }
}
 ...
 */
impl Ncs_Instruction {
    pub fn qualifier(&self) -> Ref<'_, BiowareNcsCommon_NcsInstructionQualifier> {
