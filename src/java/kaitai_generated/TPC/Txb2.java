 ...
 */
public class Txb2 extends KaitaiStruct {
    public static Txb2 fromFile(String fileName) throws IOException {
        return new Txb2(new ByteBufferKaitaiStream(fileName));
    }

    public Txb2(KaitaiStream _io) {
        this(_io, null, null);
    }

    public Txb2(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public Txb2(KaitaiStream _io, KaitaiStruct _parent, Txb2 _root) {
        super(_io);
    ...
    public Txb2 _root() { return _root; }
