...
public class Mdl extends KaitaiStruct {
    ...
    public enum ControllerType {
        ...
        private static final Map<Long, ControllerType> byId = new HashMap<Long, ControllerType>(9);
        static {
    ...
    public static class AnimationHeader extends KaitaiStruct {
        ...
        public AnimationHeader(KaitaiStream _io, Mdl _parent) {
            this(_io, _parent, null);
        }

        public AnimationHeader(KaitaiStream _io, Mdl _parent, Mdl _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
