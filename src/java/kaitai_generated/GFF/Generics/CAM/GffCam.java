 ...
 */
public class GffCam extends KaitaiStruct {
    public static GffCam fromFile(String fileName) throws IOException {
        return new GffCam(new ByteBufferKaitaiStream(fileName));
    }

    public GffCam(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffCam(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffCam(KaitaiStream _io, KaitaiStruct _parent, GffCam _root) {
        super(_io);
    ...
    public GffCam _root() { return _root; }
