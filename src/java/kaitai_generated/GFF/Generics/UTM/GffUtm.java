...
/**
 * **UTM** resources are **GFF3** on disk (Aurora `GFF ` prefix + V3.x version). Wire layout is fully defined by
 ...
 * 
 * FileType / restype id **2051** — see `bioware_type_ids::xoreos_file_type_id` enum member `utm`.
 ...
 */
public class GffUtm extends KaitaiStruct {
    public static GffUtm fromFile(String fileName) throws IOException {
        return new GffUtm(new ByteBufferKaitaiStream(fileName));
    }

    public GffUtm(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffUtm(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffUtm(KaitaiStream _io, KaitaiStruct _parent, GffUtm _root) {
        super(_io);
    ...
    private GffUtm _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per UTM template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffUtm _root() { return _root; }
