 ...
 */
public class GffBtp extends KaitaiStruct {
    public static GffBtp fromFile(String fileName) throws IOException {
        return new GffBtp(new ByteBufferKaitaiStream(fileName));
    }

    public GffBtp(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBtp(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBtp(KaitaiStream _io, KaitaiStruct _parent, GffBtp _root) {
        super(_io);
    ...
    public GffBtp _root() { return _root; }
