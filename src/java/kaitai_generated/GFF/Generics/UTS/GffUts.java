 ...
 */
public class GffUts extends KaitaiStruct {
    public static GffUts fromFile(String fileName) throws IOException {
        return new GffUts(new ByteBufferKaitaiStream(fileName));
    }

    public GffUts(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffUts(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffUts(KaitaiStream _io, KaitaiStruct _parent, GffUts _root) {
        super(_io);
    ...
    public GffUts _root() { return _root; }
