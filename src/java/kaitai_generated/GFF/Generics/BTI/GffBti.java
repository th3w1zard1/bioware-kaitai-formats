 ...
 */
public class GffBti extends KaitaiStruct {
    public static GffBti fromFile(String fileName) throws IOException {
        return new GffBti(new ByteBufferKaitaiStream(fileName));
    }

    public GffBti(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBti(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBti(KaitaiStream _io, KaitaiStruct _parent, GffBti _root) {
        super(_io);
    ...
    public GffBti _root() { return _root; }
