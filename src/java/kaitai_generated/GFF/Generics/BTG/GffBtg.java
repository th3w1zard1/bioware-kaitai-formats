 ...
 */
public class GffBtg extends KaitaiStruct {
    public static GffBtg fromFile(String fileName) throws IOException {
        return new GffBtg(new ByteBufferKaitaiStream(fileName));
    }

    public GffBtg(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBtg(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBtg(KaitaiStream _io, KaitaiStruct _parent, GffBtg _root) {
        super(_io);
    ...
    private GffBtg _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per BTG template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffBtg _root() { return _root; }
