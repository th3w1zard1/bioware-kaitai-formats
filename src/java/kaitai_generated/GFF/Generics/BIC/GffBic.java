 ...
 */
public class GffBic extends KaitaiStruct {
    public static GffBic fromFile(String fileName) throws IOException {
        return new GffBic(new ByteBufferKaitaiStream(fileName));
    }

    public GffBic(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBic(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBic(KaitaiStream _io, KaitaiStruct _parent, GffBic _root) {
        super(_io);
    ...
    private GffBic _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per BIC template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffBic _root() { return _root; }
