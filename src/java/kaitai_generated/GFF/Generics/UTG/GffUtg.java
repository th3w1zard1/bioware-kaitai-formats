 ...
 */
public class GffUtg extends KaitaiStruct {
    public static GffUtg fromFile(String fileName) throws IOException {
        return new GffUtg(new ByteBufferKaitaiStream(fileName));
    }

    public GffUtg(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffUtg(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffUtg(KaitaiStream _io, KaitaiStruct _parent, GffUtg _root) {
        super(_io);
    ...
    public GffUtg _root() { return _root; }
