...
/**
 * **PTT** resources are **GFF3** on disk (Aurora `GFF ` prefix + V3.x version). Wire layout is fully defined by
 ...
 * 
 * FileType / restype id **2066** — see `bioware_type_ids::xoreos_file_type_id` enum member `ptt`.
 ...
 */
public class GffPtt extends KaitaiStruct {
    public static GffPtt fromFile(String fileName) throws IOException {
        return new GffPtt(new ByteBufferKaitaiStream(fileName));
    }

    public GffPtt(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffPtt(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffPtt(KaitaiStream _io, KaitaiStruct _parent, GffPtt _root) {
        super(_io);
    ...
    private GffPtt _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per PTT template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffPtt _root() { return _root; }
