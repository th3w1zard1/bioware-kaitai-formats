 ...
 */
public class GffBtd extends KaitaiStruct {
    public static GffBtd fromFile(String fileName) throws IOException {
        return new GffBtd(new ByteBufferKaitaiStream(fileName));
    }

    public GffBtd(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBtd(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBtd(KaitaiStream _io, KaitaiStruct _parent, GffBtd _root) {
        super(_io);
    ...
    private GffBtd _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per BTD template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffBtd _root() { return _root; }
