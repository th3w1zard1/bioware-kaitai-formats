 ...
 */
public class GffPtm extends KaitaiStruct {
    public static GffPtm fromFile(String fileName) throws IOException {
        return new GffPtm(new ByteBufferKaitaiStream(fileName));
    }

    public GffPtm(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffPtm(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffPtm(KaitaiStream _io, KaitaiStruct _parent, GffPtm _root) {
        super(_io);
    ...
    public GffPtm _root() { return _root; }
