 ...
 */
public class GffIfo extends KaitaiStruct {
    public static GffIfo fromFile(String fileName) throws IOException {
        return new GffIfo(new ByteBufferKaitaiStream(fileName));
    }

    public GffIfo(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffIfo(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffIfo(KaitaiStream _io, KaitaiStruct _parent, GffIfo _root) {
        super(_io);
    ...
    public GffIfo _root() { return _root; }
