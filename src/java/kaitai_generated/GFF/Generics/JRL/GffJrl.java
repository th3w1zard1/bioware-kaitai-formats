...
/**
 * **JRL** resources are **GFF3** on disk (Aurora `GFF ` prefix + V3.x version). Wire layout is fully defined by
 ...
 * 
 * FileType / restype id **2056** — see `bioware_type_ids::xoreos_file_type_id` enum member `jrl`.
 ...
 */
public class GffJrl extends KaitaiStruct {
    public static GffJrl fromFile(String fileName) throws IOException {
        return new GffJrl(new ByteBufferKaitaiStream(fileName));
    }

    public GffJrl(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffJrl(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffJrl(KaitaiStream _io, KaitaiStruct _parent, GffJrl _root) {
        super(_io);
    ...
    private GffJrl _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per JRL template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffJrl _root() { return _root; }
