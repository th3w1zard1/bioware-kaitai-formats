 ...
 */
public class GffItp extends KaitaiStruct {
    public static GffItp fromFile(String fileName) throws IOException {
        return new GffItp(new ByteBufferKaitaiStream(fileName));
    }

    public GffItp(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffItp(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffItp(KaitaiStream _io, KaitaiStruct _parent, GffItp _root) {
        super(_io);
    ...
    public GffItp _root() { return _root; }
