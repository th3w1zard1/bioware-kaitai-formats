 ...
 */
public class GffUtw extends KaitaiStruct {
    public static GffUtw fromFile(String fileName) throws IOException {
        return new GffUtw(new ByteBufferKaitaiStream(fileName));
    }

    public GffUtw(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffUtw(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffUtw(KaitaiStream _io, KaitaiStruct _parent, GffUtw _root) {
        super(_io);
    ...
    public GffUtw _root() { return _root; }
