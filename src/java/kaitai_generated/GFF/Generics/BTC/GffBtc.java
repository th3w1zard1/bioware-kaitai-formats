 ...
 */
public class GffBtc extends KaitaiStruct {
    public static GffBtc fromFile(String fileName) throws IOException {
        return new GffBtc(new ByteBufferKaitaiStream(fileName));
    }

    public GffBtc(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBtc(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBtc(KaitaiStream _io, KaitaiStruct _parent, GffBtc _root) {
        super(_io);
    ...
    private GffBtc _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per BTC template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffBtc _root() { return _root; }
