 ...
 */
public class GffBts extends KaitaiStruct {
    public static GffBts fromFile(String fileName) throws IOException {
        return new GffBts(new ByteBufferKaitaiStream(fileName));
    }

    public GffBts(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBts(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBts(KaitaiStream _io, KaitaiStruct _parent, GffBts _root) {
        super(_io);
    ...
    private GffBts _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per BTS template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffBts _root() { return _root; }
