 ...
 */
public class GffBte extends KaitaiStruct {
    public static GffBte fromFile(String fileName) throws IOException {
        return new GffBte(new ByteBufferKaitaiStream(fileName));
    }

    public GffBte(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBte(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBte(KaitaiStream _io, KaitaiStruct _parent, GffBte _root) {
        super(_io);
    ...
    public GffBte _root() { return _root; }
