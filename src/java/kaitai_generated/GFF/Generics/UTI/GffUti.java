 ...
 */
public class GffUti extends KaitaiStruct {
    public static GffUti fromFile(String fileName) throws IOException {
        return new GffUti(new ByteBufferKaitaiStream(fileName));
    }

    public GffUti(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffUti(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffUti(KaitaiStream _io, KaitaiStruct _parent, GffUti _root) {
        super(_io);
    ...
    public GffUti _root() { return _root; }
