 ...
 */
public class GffDlg extends KaitaiStruct {
    public static GffDlg fromFile(String fileName) throws IOException {
        return new GffDlg(new ByteBufferKaitaiStream(fileName));
    }

    public GffDlg(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffDlg(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffDlg(KaitaiStream _io, KaitaiStruct _parent, GffDlg _root) {
        super(_io);
    ...
    public GffDlg _root() { return _root; }
