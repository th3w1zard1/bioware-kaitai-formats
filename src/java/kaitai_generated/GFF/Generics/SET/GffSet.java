 ...
 */
public class GffSet extends KaitaiStruct {
    public static GffSet fromFile(String fileName) throws IOException {
        return new GffSet(new ByteBufferKaitaiStream(fileName));
    }

    public GffSet(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffSet(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffSet(KaitaiStream _io, KaitaiStruct _parent, GffSet _root) {
        super(_io);
    ...
    public GffSet _root() { return _root; }
