 ...
 */
public class GffFac extends KaitaiStruct {
    public static GffFac fromFile(String fileName) throws IOException {
        return new GffFac(new ByteBufferKaitaiStream(fileName));
    }

    public GffFac(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffFac(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffFac(KaitaiStream _io, KaitaiStruct _parent, GffFac _root) {
        super(_io);
    ...
    public GffFac _root() { return _root; }
