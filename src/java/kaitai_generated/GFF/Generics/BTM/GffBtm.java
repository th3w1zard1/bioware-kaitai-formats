 ...
 */
public class GffBtm extends KaitaiStruct {
    public static GffBtm fromFile(String fileName) throws IOException {
        return new GffBtm(new ByteBufferKaitaiStream(fileName));
    }

    public GffBtm(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffBtm(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffBtm(KaitaiStream _io, KaitaiStruct _parent, GffBtm _root) {
        super(_io);
    ...
    public GffBtm _root() { return _root; }
