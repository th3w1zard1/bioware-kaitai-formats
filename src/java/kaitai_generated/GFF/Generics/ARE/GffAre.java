 ...
 */
public class GffAre extends KaitaiStruct {
    public static GffAre fromFile(String fileName) throws IOException {
        return new GffAre(new ByteBufferKaitaiStream(fileName));
    }

    public GffAre(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffAre(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffAre(KaitaiStream _io, KaitaiStruct _parent, GffAre _root) {
        super(_io);
    ...
    public GffAre _root() { return _root; }
