...
/**
 * **CUT** resources are **GFF3** on disk (Aurora `GFF ` prefix + V3.x version). Wire layout is fully defined by
 ...
 * 
 * FileType / restype id **2074** — see `bioware_type_ids::xoreos_file_type_id` enum member `cut`.
 ...
 */
public class GffCut extends KaitaiStruct {
    public static GffCut fromFile(String fileName) throws IOException {
        return new GffCut(new ByteBufferKaitaiStream(fileName));
    }

    public GffCut(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffCut(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffCut(KaitaiStream _io, KaitaiStruct _parent, GffCut _root) {
        super(_io);
    ...
    private GffCut _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per CUT template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffCut _root() { return _root; }
