 ...
 */
public class GffGit extends KaitaiStruct {
    public static GffGit fromFile(String fileName) throws IOException {
        return new GffGit(new ByteBufferKaitaiStream(fileName));
    }

    public GffGit(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffGit(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffGit(KaitaiStream _io, KaitaiStruct _parent, GffGit _root) {
        super(_io);
    ...
    private GffGit _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per GIT template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffGit _root() { return _root; }
