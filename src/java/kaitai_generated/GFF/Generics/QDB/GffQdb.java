 ...
 */
public class GffQdb extends KaitaiStruct {
    public static GffQdb fromFile(String fileName) throws IOException {
        return new GffQdb(new ByteBufferKaitaiStream(fileName));
    }

    public GffQdb(KaitaiStream _io) {
        this(_io, null, null);
    }

    public GffQdb(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public GffQdb(KaitaiStream _io, KaitaiStruct _parent, GffQdb _root) {
        super(_io);
    ...
    private GffQdb _root;
    private KaitaiStruct _parent;

    /**
     * Full GFF3/GFF4 union (see `GFF.ksy`); interpret struct labels per QDB template docs / PyKotor `gff_auto`.
     */
    public Gff.GffUnionFile contents() { return contents; }
    public GffQdb _root() { return _root; }
