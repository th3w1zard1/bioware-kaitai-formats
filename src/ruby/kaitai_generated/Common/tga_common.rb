...
# @see https://github.com/OpenKotOR/PyKotor/wiki/Texture-Formats#tpc PyKotor wiki — textures (TGA pipeline)
# @see https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/tpc/tga.py#L1-L40 PyKotor — `tga.py` (reader core)
# @see https://github.com/xoreos/xoreos/blob/master/src/graphics/images/tga.cpp#L89-L177 xoreos — `TGA::readHeader`
# @see https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L61 xoreos — `kFileTypeTGA`
# @see https://github.com/xoreos/xoreos-tools/blob/master/src/images/tga.cpp#L68-L80 xoreos-tools — `TGA::load`
# @see https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware xoreos-docs — BioWare specs PDF tree
# @see https://github.com/xoreos/xoreos-docs/blob/master/specs/kotor_mdl.html xoreos-docs — KotOR MDL overview (texture context)
