...
# @see https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ltr/io_ltr.py#L44-L155 PyKotor — `io_ltr` reader/writer (start of `write`)
# @see https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L101 xoreos — `kFileTypeLTR`
# @see https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L121-L133 xoreos — `LTRFile::readLetterSet`
# @see https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L135-L168 xoreos — `LTRFile::load`
# @see https://github.com/modawan/reone/blob/master/src/libs/resource/format/ltrreader.cpp#L27-L74 reone — `LtrReader::load` + `readLetterSet`
# @see https://github.com/KobaltBlu/KotOR.js/blob/master/src/resource/LTRObject.ts#L51-L122 KotOR.js — `LTRObject.readBuffer`
# @see https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware xoreos-docs — BioWare specs tree (no dedicated LTR Torlack page; use `ltrfile.cpp` + PyKotor)
