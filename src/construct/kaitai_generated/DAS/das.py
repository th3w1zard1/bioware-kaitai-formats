...
das__length_prefixed_string = Struct(
	'length' / Int32sl,
...
das = Struct(
	...
	'version' / Int32sl,
	'save_name' / LazyBound(lambda: das__length_prefixed_string),
	'module_name' / LazyBound(lambda: das__length_prefixed_string),
	'area_name' / LazyBound(lambda: das__length_prefixed_string),
	...
	'player_name' / LazyBound(lambda: das__length_prefixed_string),
