...
class bioware_mdl_common__controller_type(enum.IntEnum):
	position = 8
	orientation = 20
	scale = 36
	color = 76
...
class bioware_mdl_common__model_classification(enum.IntEnum):
	other = 0
	effect = 1
	tile = 2
	character = 4
...
class bioware_mdl_common__node_type_value(enum.IntEnum):
	dummy = 1
	light = 3
	emitter = 5
	reference = 17
...
bioware_mdl_common = Struct(
)

_schema = bioware_mdl_common
