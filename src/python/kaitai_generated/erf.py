...
class Erf(KaitaiStruct):
    ...
    .. seealso::
       NickHugi/Kotor.NET — `ERFBinaryStructure.FileRoot` read/write - https://github.com/NickHugi/Kotor.NET/blob/master/Kotor.NET/Formats/KotorERF/ERFBinaryStructure.cs#L25-L66
    ...
    .. seealso::
       PyKotor — `ResourceType` (tooling superset; overlaps FileType for KotOR rows) - https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/type.py#L123-L322
    """
