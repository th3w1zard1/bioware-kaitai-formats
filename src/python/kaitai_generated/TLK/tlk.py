...
class Tlk(KaitaiStruct):
    ...
    .. seealso::
       NickHugi/Kotor.NET — `TLKBinaryReader` - https://github.com/NickHugi/Kotor.NET/blob/master/Kotor.NET/Formats/KotorTLK/TLKBinaryReader.cs
    ...
    class StringDataEntry(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.sound_resref = (self._io.read_bytes(16)).decode("ASCII")
        ...
        def text_data(self):
            ...
            self._m_text_data = (self._io.read_bytes(self.text_length)).decode("ASCII")
            self._io.seek(_pos)
        ...
        def text_file_offset(self):
            ...
            self._m_text_file_offset = (
                self._root.header.entries_offset + self.text_offset
            )
