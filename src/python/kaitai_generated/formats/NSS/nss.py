...
class Nss(KaitaiStruct):
    ...
    .. seealso::
       xoreos — `kFileTypeNSS` / `kFileTypeNCS` (Aurora `FileType` IDs; NSS plaintext, NCS bytecode) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L85-L86
    
    
    .. seealso::
       xoreos-tools — `NCSFile` - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/nwscript/ncsfile.cpp#L106-L137
    
    
    .. seealso::
       reone — `NssWriter::save` - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/tools/script/format/nsswriter.cpp#L33-L45
    
    
    .. seealso::
       xoreos-docs — Torlack NCS (bytecode companion to plaintext NSS) - https://github.com/xoreos/xoreos-docs/blob/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/torlack/ncs.html
