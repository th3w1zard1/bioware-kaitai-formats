...
class Pcc(KaitaiStruct):
    ...
    **Not KotOR:** no `k1_win_gog_swkotor.exe` grounding — follow LegendaryExplorer wiki + `meta.xref`.
    ...
    .. seealso::
       xoreos — `FileType` enum start (Aurora/BioWare family IDs; **PCC/Unreal packages are not in this table** — included only as canonical upstream anchor for “what this repo’s xoreos stack is”) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L53-L60
    ...
    .. seealso::
       In-tree — coverage matrix (PCC is out-of-xoreos Aurora scope; see table) - https://github.com/OpenKotOR/bioware-kaitai-formats/blob/f4700f43f20337e01b8ef751a7c7d42e0acfb00a/docs/XOREOS_FORMAT_COVERAGE.md
    
    
    .. seealso::
       xoreos-docs — BioWare specs tree (KotOR-era PDFs; PCC is Mass Effect / UE3 — use LegendaryExplorer wiki as wire authority) - https://github.com/xoreos/xoreos-docs/tree/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/bioware
    """
    ...
    class NameEntry(KaitaiStruct):
        ...
        @property
        def name_size(self):
            """Size of name string in bytes (absolute length * 2 (0x2) bytes per WCHAR)."""
