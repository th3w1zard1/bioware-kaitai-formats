...
class Mdl(KaitaiStruct):
    ...
    .. seealso::
       In-tree — shared MDL/MDX wire enums (`bioware_mdl_common`) - https://github.com/OpenKotOR/bioware-kaitai-formats/blob/f4700f43f20337e01b8ef751a7c7d42e0acfb00a/formats/Common/bioware_mdl_common.ksy
    ...
    .. seealso::
       PyKotor — MDLBinaryReader (binary MDL/MDX) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/mdl/io_mdl.py#L2260-L2408
    ...
    .. seealso::
       xoreos — `Model_KotOR::ParserContext` (MDL/MDX stream pointers + cached header fields consumed during binary load) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/graphics/aurora/model_kotor.h#L45-L79
    ...
    .. seealso::
       xoreos-docs — Torlack binmdl (controller / Aurora background) - https://github.com/xoreos/xoreos-docs/blob/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/torlack/binmdl.html
    
    
    .. seealso::
       reone — MdlMdxReader::load - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/graphics/format/mdlmdxreader.cpp#L55-L118
    
    
    .. seealso::
       KotOR.js — OdysseyModel binary constructor - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/odyssey/OdysseyModel.ts#L56-L170
    
    
    .. seealso::
       Community MDLOps — controller name table - https://github.com/OpenKotOR/MDLOps/blob/7e40846d36acb5118e2e9feb2fd53620c29be540/MDLOpsM.pm#L342-L407
    
    
    .. seealso::
       Community MDLOps — `readasciimdl` (ASCII MDL ingest) - https://github.com/OpenKotOR/MDLOps/blob/7e40846d36acb5118e2e9feb2fd53620c29be540/MDLOpsM.pm#L3916-L4698
    """
    ...
    class AabbHeader(KaitaiStruct):
        """AABB (Axis-Aligned Bounding Box) header (336 (0x150) bytes KOTOR 1, 344 (0x158) bytes KOTOR 2) - extends trimesh_header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class AnimationHeader(KaitaiStruct):
        """Animation header (136 (0x88) bytes = 80 (0x50) byte geometry header + 56 (0x38) byte animation header)."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class AnimmeshHeader(KaitaiStruct):
        """Animmesh header (388 (0x184) bytes KOTOR 1, 396 (0x18c) bytes KOTOR 2) - extends trimesh_header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class Controller(KaitaiStruct):
        """Controller structure (16 (0x10) bytes) - defines animation data for a node property over time."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class DanglymeshHeader(KaitaiStruct):
        """Danglymesh header (360 (0x168) bytes KOTOR 1, 368 (0x170) bytes KOTOR 2) - extends trimesh_header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class LightsaberHeader(KaitaiStruct):
        """Lightsaber header (352 (0x160) bytes KOTOR 1, 360 (0x168) bytes KOTOR 2) - extends trimesh_header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class Node(KaitaiStruct):
        """Node structure - starts with 80 (0x50)-byte header, followed by type-specific sub-header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class NodeHeader(KaitaiStruct):
        """Node header (80 (0x50) bytes) - present in all node types."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class SkinmeshHeader(KaitaiStruct):
        """Skinmesh header (432 (0x1b0) bytes KOTOR 1, 440 (0x1b8) bytes KOTOR 2) - extends trimesh_header."""
        def __init__(self, _io, _parent=None, _root=None):
    ...
    class TrimeshHeader(KaitaiStruct):
        """Trimesh header (332 (0x14c) bytes KOTOR 1, 340 (0x154) bytes KOTOR 2)."""
        def __init__(self, _io, _parent=None, _root=None):
