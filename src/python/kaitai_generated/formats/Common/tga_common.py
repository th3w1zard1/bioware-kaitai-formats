...
class TgaCommon(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — `tga.py` (reader core) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/tpc/tga.py#L1-L40
    ...
    .. seealso::
       xoreos — `kFileTypeTGA` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L61
    
    
    .. seealso::
       xoreos-tools — `TGA::load` - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/images/tga.cpp#L68-L80
