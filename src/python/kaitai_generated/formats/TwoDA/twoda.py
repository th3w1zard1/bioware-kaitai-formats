...
class Twoda(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — `io_twoda` (binary `V2.b` + writer) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/twoda/io_twoda.py#L25-L238
    
    
    .. seealso::
       PyKotor — `twoda_data` (model + ASCII/binary notes) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/twoda/twoda_data.py#L8-L114
    
    
    .. seealso::
       xoreos — `k2DAID` / `k2DAIDTab` + version tags - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/2dafile.cpp#L48-L51
    
    
    .. seealso::
       xoreos — `TwoDAFile::load` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/2dafile.cpp#L145-L172
    
    
    .. seealso::
       xoreos — binary `V2.b` (`read2b` + `readHeaders2b` / `skipRowNames2b` / `readRows2b`) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/2dafile.cpp#L192-L336
    
    
    .. seealso::
       xoreos — `TwoDAFile::writeBinary` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/2dafile.cpp#L517-L611
    
    
    .. seealso::
       xoreos-tools — `convert2da` CLI (`main`) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/convert2da.cpp#L64-L86
    
    
    .. seealso::
       xoreos-tools — `get2DAGDA` / `TwoDAFile` dispatch - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/convert2da.cpp#L143-L159
    ...
    .. seealso::
       KotOR.js — `TwoDAObject` - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/resource/TwoDAObject.ts#L69-L155
