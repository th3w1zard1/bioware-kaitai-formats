...
class Txb(KaitaiStruct):
    ...
    .. seealso::
       In-tree — `CResTPC::OnResourceServiced` / 128 (0x80)-byte header (**observed behavior** for K1 + TSL in `meta.xref` on `DDS.ksy`) - https://github.com/OpenKotOR/bioware-kaitai-formats/blob/f4700f43f20337e01b8ef751a7c7d42e0acfb00a/formats/TPC/DDS.ksy
    
    
    .. seealso::
       xoreos — `kFileTypeTXB` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L182
