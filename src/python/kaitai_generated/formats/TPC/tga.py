...
class Tga(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — compact TGA reader (`tga.py`) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/tpc/tga.py#L1-L40
    
    
    .. seealso::
       PyKotor — TGA↔TPC bridge (`io_tga.py`, `_write_tga_rgba` + `TPCTGAReader`) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/tpc/io_tga.py#L60-L120
    
    
    .. seealso::
       xoreos — `TGA::readHeader` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/graphics/images/tga.cpp#L89-L177
    
    
    .. seealso::
       xoreos-tools — `TGA::load` through `readRLE` (tooling reader) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/images/tga.cpp#L68-L241
