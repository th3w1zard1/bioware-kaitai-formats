...
class Gff(KaitaiStruct):
    ...
    **Pinned URLs and tool history:** `meta.xref` (alphabetical keys). Coverage matrix: `docs/XOREOS_FORMAT_COVERAGE.md`.
    ...
    .. seealso::
       xoreos — GFF3File::Header::read - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/gff3file.cpp#L50-L63
    
    
    .. seealso::
       xoreos — GFF3File load (post-header struct/field arena wiring) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/gff3file.cpp#L110-L181
    
    
    .. seealso::
       xoreos — GFF4File::Header::read - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/gff4file.cpp#L48-L72
    
    
    .. seealso::
       xoreos — G2DA `kG2DAID` + `kVersion01` / `kVersion02` (pair with in-tree `gff4_g2da_*` enums) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/gdafile.cpp#L40-L42
    
    
    .. seealso::
       xoreos — GFF4File::load entry - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/gff4file.cpp#L151-L164
    ...
    .. seealso::
       PyKotor — GFFBinaryReader.load - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/gff/io_gff.py#L70-L114
    
    
    .. seealso::
       reone — GffReader - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/resource/format/gffreader.cpp#L27-L225
    
    
    .. seealso::
       KotOR.js — GFFObject.parse - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/resource/GFFObject.ts#L152-L221
    
    
    .. seealso::
       xoreos-tools — GFF3 load pipeline (shared with CLIs) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/aurora/gff3file.cpp#L86-L238
    
    
    .. seealso::
       xoreos-tools — `gffdumper` - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/xml/gffdumper.cpp#L36-L176
    
    
    .. seealso::
       xoreos-tools — `gffcreator` - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/xml/gffcreator.cpp#L43-L60
    
    
    .. seealso::
       xoreos-docs — GFF_Format.pdf - https://github.com/xoreos/xoreos-docs/blob/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/bioware/GFF_Format.pdf
    """
