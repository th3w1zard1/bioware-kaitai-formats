...
class Ltr(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — `io_ltr` reader/writer (start of `write`) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/ltr/io_ltr.py#L44-L155
    
    
    .. seealso::
       xoreos — `kFileTypeLTR` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L101
    
    
    .. seealso::
       xoreos — `LTRFile::readLetterSet` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/ltrfile.cpp#L121-L133
    
    
    .. seealso::
       xoreos — `LTRFile::load` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/ltrfile.cpp#L135-L168
    
    
    .. seealso::
       reone — `LtrReader::load` + `readLetterSet` - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/resource/format/ltrreader.cpp#L27-L74
    
    
    .. seealso::
       KotOR.js — `LTRObject.readBuffer` - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/resource/LTRObject.ts#L51-L122
    
    
    .. seealso::
       xoreos-docs — BioWare specs tree (no dedicated LTR Torlack page; use `ltrfile.cpp` + PyKotor) - https://github.com/xoreos/xoreos-docs/tree/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/bioware
    """
