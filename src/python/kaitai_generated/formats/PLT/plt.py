...
class Plt(KaitaiStruct):
    ...
    **reone:** the KotOR-focused fork does not ship a standalone PLT body reader; see `meta.xref.reone_resource_type_plt_note` for the numeric `Plt` type id only.
    ...
    .. seealso::
       PyKotor — `ResourceType.PLT` (NWN-era id 6) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/type.py#L374-L380
    ...
    .. seealso::
       xoreos-tools — shipped CLI inventory (no PLT-specific tool on `master`) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/README.md#L17-L43
    ...
    .. seealso::
       reone — `ResourceType::Plt` (id 6; no `.plt` wire reader on default branch) - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/include/reone/resource/types.h#L35
    """
