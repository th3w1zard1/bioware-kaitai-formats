...
class Tlk(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — `io_tlk` (sizes, Kaitai + legacy + write) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/tlk/io_tlk.py#L23-L196
    
    
    .. seealso::
       xoreos — `TalkTable::load` (factory dispatch) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/talktable.cpp#L35-L69
    
    
    .. seealso::
       xoreos — TLK id/version + `TalkTable_TLK::load` + V3/V4 entry tables - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/talktable_tlk.cpp#L40-L114
    
    
    .. seealso::
       xoreos — `kFileTypeTLK` - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L87
    
    
    .. seealso::
       xoreos — `Language` / `LanguageGender` (TLK `language_id` / substring packing) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/language.h#L46-L73
    
    
    .. seealso::
       xoreos-tools — `tlk2xml` CLI (`main`) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/tlk2xml.cpp#L56-L80
    
    
    .. seealso::
       xoreos-tools — `xml2tlk` CLI (`main`) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/src/xml2tlk.cpp#L58-L85
    
    
    .. seealso::
       reone — `TlkReader` - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/resource/format/tlkreader.cpp#L27-L67
    
    
    .. seealso::
       KotOR.js — `TLKObject` - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/resource/TLKObject.ts#L16-L77
    
    
    .. seealso::
       NickHugi/Kotor.NET — `TLKBinaryReader` (`Read` + constructors) - https://github.com/NickHugi/Kotor.NET/blob/6dca4a6a1af2fee6e36befb9a6f127c8ba04d3e2/Kotor.NET/Formats/KotorTLK/TLKBinaryReader.cs#L16-L52
