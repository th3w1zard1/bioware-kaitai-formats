...
class Wav(KaitaiStruct):
    ...
    .. seealso::
       PyKotor — `io_wav` (Kaitai RIFF parse + `WAVBinaryReader.load` + legacy) - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/wav/io_wav.py#L43-L187
    
    
    .. seealso::
       reone — `WavReader` (fake header + chunk loop) - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/audio/format/wavreader.cpp#L30-L72
    
    
    .. seealso::
       xoreos — `makeWAVStream` / chunk scan - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/sound/decoders/wave.cpp#L38-L106
    
    
    .. seealso::
       xoreos — `SoundManager::makeAudioStream` KotOR WAVE quirks - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/sound/sound.cpp#L256-L340
    
    
    .. seealso::
       xoreos — `kFileTypeWAV` (numeric id) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/aurora/types.h#L62
    
    
    .. seealso::
       KotOR.js — `AudioFile` (prefix + MP3-in-WAV) - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/audio/AudioFile.ts#L10-L145
    
    
    .. seealso::
       xoreos-docs — BioWare specs PDF tree (no dedicated WAV PDF; discoverability anchor) - https://github.com/xoreos/xoreos-docs/tree/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/bioware
    """
