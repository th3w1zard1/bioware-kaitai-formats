...
class Bwm(KaitaiStruct):
    ...
    .. seealso::
       xoreos-tools — shipped CLI inventory (no BWM-specific tool) - https://github.com/xoreos/xoreos-tools/blob/b2ebf4fb98b423d94adf5092fd2d10f5d128ffd3/README.md#L17-L43
    ...
    .. seealso::
       PyKotor — Kaitai-backed BWM struct load - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/bwm/io_bwm.py#L56-L110
    
    
    .. seealso::
       PyKotor — BWMBinaryReader.load - https://github.com/OpenKotOR/PyKotor/blob/e03ea2c077f1be1d6704d228d156748a9cc3d0eb/Libraries/PyKotor/src/pykotor/resource/formats/bwm/io_bwm.py#L187-L253
    
    
    .. seealso::
       xoreos — WalkmeshLoader::load - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/engines/kotorbase/path/walkmeshloader.cpp#L42-L113
    
    
    .. seealso::
       xoreos — WalkmeshLoader (append tables / WOK-only paths) - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/engines/kotorbase/path/walkmeshloader.cpp#L119-L216
    
    
    .. seealso::
       xoreos — WalkmeshLoader::getAABB - https://github.com/xoreos/xoreos/blob/89c99d2a93c23f3ba2b1218759e38775e4f2bdf9/src/engines/kotorbase/path/walkmeshloader.cpp#L218-L249
    
    
    .. seealso::
       reone — BwmReader::load - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/graphics/format/bwmreader.cpp#L27-L92
    
    
    .. seealso::
       reone — BwmReader (AABB / adjacency tables) - https://github.com/modawan/reone/blob/61531089341caf5827abbc54346c8c959b03d449/src/libs/graphics/format/bwmreader.cpp#L94-L171
    
    
    .. seealso::
       KotOR.js — readBinary - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/odyssey/OdysseyWalkMesh.ts#L301-L395
    
    
    .. seealso::
       KotOR.js — header / version constants - https://github.com/KobaltBlu/KotOR.js/blob/83b27e2b4c61dfa6723e67995592c53ac88b21d9/src/odyssey/OdysseyWalkMesh.ts#L490-L516
    
    
    .. seealso::
       xoreos-docs — BioWare specs tree (no dedicated BWM / walkmesh Torlack page; use engine + PyKotor xrefs above) - https://github.com/xoreos/xoreos-docs/tree/4e1c197aa09b532ef466ff8ceccfd6221e80c3c9/specs/bioware
    """
