...
class Mdx(KaitaiStruct):
    ...
    .. seealso::
       KotOR.js — `OdysseyModelNodeMesh.readBinary` (MDL header + MDX interleaved vertex loop) - https://github.com/KobaltBlu/KotOR.js/blob/master/src/odyssey/OdysseyModelNodeMesh.ts#L104-L281
    
    
    .. seealso::
       KotOR.js — `OdysseyModelMDXFlag` enum - https://github.com/KobaltBlu/KotOR.js/blob/master/src/enums/odyssey/OdysseyModelMDXFlag.ts#L14-L27
    """
