...
sub _read {
    ...
    $self->{save_name} = Das::LengthPrefixedString->new($self->{_io}, $self, $self->{_root});
    $self->{module_name} = Das::LengthPrefixedString->new($self->{_io}, $self, $self->{_root});
    $self->{area_name} = Das::LengthPrefixedString->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{player_name} = Das::LengthPrefixedString->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package Das::LengthPrefixedString;
