 ...
 * \sa https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ltr/io_ltr.py#L44-L155 PyKotor — `io_ltr` reader/writer (start of `write`)
 * \sa https://github.com/xoreos/xoreos/blob/master/src/aurora/types.h#L101 xoreos — `kFileTypeLTR`
 * \sa https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L121-L133 xoreos — `LTRFile::readLetterSet`
 * \sa https://github.com/xoreos/xoreos/blob/master/src/aurora/ltrfile.cpp#L135-L168 xoreos — `LTRFile::load`
 * \sa https://github.com/modawan/reone/blob/master/src/libs/resource/format/ltrreader.cpp#L27-L74 reone — `LtrReader::load` + `readLetterSet`
 * \sa https://github.com/KobaltBlu/KotOR.js/blob/master/src/resource/LTRObject.ts#L51-L122 KotOR.js — `LTRObject.readBuffer`
 * \sa https://github.com/xoreos/xoreos-docs/tree/master/specs/bioware xoreos-docs — BioWare specs tree (no dedicated LTR Torlack page; use `ltrfile.cpp` + PyKotor)
 */
