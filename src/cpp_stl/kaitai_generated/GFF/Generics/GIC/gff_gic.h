...
class gff_gic_t : public kaitai::kstruct {

public:

    gff_gic_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_gic_t* p__root = 0);
...
public:
    ...
    gff_gic_t* _root() const { return m__root; }
