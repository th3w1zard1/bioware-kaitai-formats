...
class gff_utg_t : public kaitai::kstruct {

public:

    gff_utg_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utg_t* p__root = 0);
...
public:
    ...
    gff_utg_t* _root() const { return m__root; }
