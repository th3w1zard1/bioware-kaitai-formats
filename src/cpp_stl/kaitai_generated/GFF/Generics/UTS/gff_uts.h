...
class gff_uts_t : public kaitai::kstruct {

public:

    gff_uts_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_uts_t* p__root = 0);
...
public:
    ...
    gff_uts_t* _root() const { return m__root; }
