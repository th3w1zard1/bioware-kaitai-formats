...
class gff_pth_t : public kaitai::kstruct {

public:

    gff_pth_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_pth_t* p__root = 0);
...
public:
    ...
    gff_pth_t* _root() const { return m__root; }
