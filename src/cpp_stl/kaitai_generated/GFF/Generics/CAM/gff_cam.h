...
class gff_cam_t : public kaitai::kstruct {

public:

    gff_cam_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_cam_t* p__root = 0);
...
public:
    ...
    gff_cam_t* _root() const { return m__root; }
