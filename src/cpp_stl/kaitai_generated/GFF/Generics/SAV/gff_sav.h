...
class gff_sav_t : public kaitai::kstruct {

public:

    gff_sav_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_sav_t* p__root = 0);
...
public:
    ...
    gff_sav_t* _root() const { return m__root; }
