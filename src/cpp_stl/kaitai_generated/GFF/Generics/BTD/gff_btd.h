...
class gff_btd_t : public kaitai::kstruct {

public:

    gff_btd_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btd_t* p__root = 0);
...
public:
    ...
    gff_btd_t* _root() const { return m__root; }
