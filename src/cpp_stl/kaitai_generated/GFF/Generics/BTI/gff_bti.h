...
class gff_bti_t : public kaitai::kstruct {

public:

    gff_bti_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_bti_t* p__root = 0);
...
public:
    ...
    gff_bti_t* _root() const { return m__root; }
