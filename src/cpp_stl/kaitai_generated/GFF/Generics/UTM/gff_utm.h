...
class gff_utm_t : public kaitai::kstruct {

public:

    gff_utm_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utm_t* p__root = 0);
...
public:
    ...
    gff_utm_t* _root() const { return m__root; }
