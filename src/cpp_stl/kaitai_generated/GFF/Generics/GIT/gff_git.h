...
class gff_git_t : public kaitai::kstruct {

public:

    gff_git_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_git_t* p__root = 0);
...
public:
    ...
    gff_git_t* _root() const { return m__root; }
