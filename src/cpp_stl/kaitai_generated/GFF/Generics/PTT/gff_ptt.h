...
class gff_ptt_t : public kaitai::kstruct {

public:

    gff_ptt_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_ptt_t* p__root = 0);
...
public:
    ...
    gff_ptt_t* _root() const { return m__root; }
