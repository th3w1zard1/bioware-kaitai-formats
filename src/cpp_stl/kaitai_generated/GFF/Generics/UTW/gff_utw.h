...
class gff_utw_t : public kaitai::kstruct {

public:

    gff_utw_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utw_t* p__root = 0);
...
public:
    ...
    gff_utw_t* _root() const { return m__root; }
