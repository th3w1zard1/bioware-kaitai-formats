...
class gff_btc_t : public kaitai::kstruct {

public:

    gff_btc_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btc_t* p__root = 0);
...
public:
    ...
    gff_btc_t* _root() const { return m__root; }
