...
class gff_utd_t : public kaitai::kstruct {

public:

    gff_utd_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utd_t* p__root = 0);
...
public:
    ...
    gff_utd_t* _root() const { return m__root; }
