...
class gff_utp_t : public kaitai::kstruct {

public:

    gff_utp_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utp_t* p__root = 0);
...
public:
    ...
    gff_utp_t* _root() const { return m__root; }
