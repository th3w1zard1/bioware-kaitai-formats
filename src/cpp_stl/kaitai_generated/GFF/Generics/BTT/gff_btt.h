...
class gff_btt_t : public kaitai::kstruct {

public:

    gff_btt_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btt_t* p__root = 0);
...
public:
    ...
    gff_btt_t* _root() const { return m__root; }
