...
class gff_uti_t : public kaitai::kstruct {

public:

    gff_uti_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_uti_t* p__root = 0);
...
public:
    ...
    gff_uti_t* _root() const { return m__root; }
