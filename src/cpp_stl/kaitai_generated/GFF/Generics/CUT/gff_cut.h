...
class gff_cut_t : public kaitai::kstruct {

public:

    gff_cut_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_cut_t* p__root = 0);
...
public:
    ...
    gff_cut_t* _root() const { return m__root; }
