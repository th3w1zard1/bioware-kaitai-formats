...
class gff_gui_t : public kaitai::kstruct {

public:

    gff_gui_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_gui_t* p__root = 0);
...
public:
    ...
    gff_gui_t* _root() const { return m__root; }
