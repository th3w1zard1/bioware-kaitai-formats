...
class gff_jrl_t : public kaitai::kstruct {

public:

    gff_jrl_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_jrl_t* p__root = 0);
...
public:
    ...
    gff_jrl_t* _root() const { return m__root; }
