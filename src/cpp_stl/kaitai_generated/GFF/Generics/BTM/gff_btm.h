...
class gff_btm_t : public kaitai::kstruct {

public:

    gff_btm_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btm_t* p__root = 0);
...
public:
    ...
    gff_btm_t* _root() const { return m__root; }
