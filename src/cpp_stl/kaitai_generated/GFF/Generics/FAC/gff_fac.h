...
class gff_fac_t : public kaitai::kstruct {

public:

    gff_fac_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_fac_t* p__root = 0);
...
public:
    ...
    gff_fac_t* _root() const { return m__root; }
