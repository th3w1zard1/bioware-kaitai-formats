...
class gff_bic_t : public kaitai::kstruct {

public:

    gff_bic_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_bic_t* p__root = 0);
...
public:
    ...
    gff_bic_t* _root() const { return m__root; }
