...
class gff_dlg_t : public kaitai::kstruct {

public:

    gff_dlg_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_dlg_t* p__root = 0);
...
public:
    ...
    gff_dlg_t* _root() const { return m__root; }
