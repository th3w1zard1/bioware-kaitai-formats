...
class gff_qst_t : public kaitai::kstruct {

public:

    gff_qst_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_qst_t* p__root = 0);
...
public:
    ...
    gff_qst_t* _root() const { return m__root; }
