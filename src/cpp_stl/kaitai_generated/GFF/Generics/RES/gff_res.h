...
class gff_res_t : public kaitai::kstruct {

public:

    gff_res_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_res_t* p__root = 0);
...
public:
    ...
    gff_res_t* _root() const { return m__root; }
