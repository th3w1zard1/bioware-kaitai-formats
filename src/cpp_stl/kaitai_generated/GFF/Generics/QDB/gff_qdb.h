...
class gff_qdb_t : public kaitai::kstruct {

public:

    gff_qdb_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_qdb_t* p__root = 0);
...
public:
    ...
    gff_qdb_t* _root() const { return m__root; }
