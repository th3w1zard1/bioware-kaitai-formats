...
class gff_btp_t : public kaitai::kstruct {

public:

    gff_btp_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btp_t* p__root = 0);
...
public:
    ...
    gff_btp_t* _root() const { return m__root; }
