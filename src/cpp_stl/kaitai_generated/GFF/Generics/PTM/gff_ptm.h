...
class gff_ptm_t : public kaitai::kstruct {

public:

    gff_ptm_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_ptm_t* p__root = 0);
...
public:
    ...
    gff_ptm_t* _root() const { return m__root; }
