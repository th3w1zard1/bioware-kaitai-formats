...
class gff_are_t : public kaitai::kstruct {

public:

    gff_are_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_are_t* p__root = 0);
...
public:
    ...
    gff_are_t* _root() const { return m__root; }
