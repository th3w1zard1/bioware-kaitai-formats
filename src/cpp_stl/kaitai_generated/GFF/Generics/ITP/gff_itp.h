...
class gff_itp_t : public kaitai::kstruct {

public:

    gff_itp_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_itp_t* p__root = 0);
...
public:
    ...
    gff_itp_t* _root() const { return m__root; }
