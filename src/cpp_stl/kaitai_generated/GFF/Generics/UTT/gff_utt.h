...
class gff_utt_t : public kaitai::kstruct {

public:

    gff_utt_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utt_t* p__root = 0);
...
public:
    ...
    gff_utt_t* _root() const { return m__root; }
