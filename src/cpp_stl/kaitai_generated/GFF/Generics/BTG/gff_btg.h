...
class gff_btg_t : public kaitai::kstruct {

public:

    gff_btg_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_btg_t* p__root = 0);
...
public:
    ...
    gff_btg_t* _root() const { return m__root; }
