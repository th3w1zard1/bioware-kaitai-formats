...
class gff_utc_t : public kaitai::kstruct {

public:

    gff_utc_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_utc_t* p__root = 0);
...
public:
    ...
    gff_utc_t* _root() const { return m__root; }
