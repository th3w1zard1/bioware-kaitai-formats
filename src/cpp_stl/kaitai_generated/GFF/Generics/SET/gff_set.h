...
class gff_set_t : public kaitai::kstruct {

public:

    gff_set_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_set_t* p__root = 0);
...
public:
    ...
    gff_set_t* _root() const { return m__root; }
