...
class gff_ute_t : public kaitai::kstruct {

public:

    gff_ute_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_ute_t* p__root = 0);
...
public:
    ...
    gff_ute_t* _root() const { return m__root; }
