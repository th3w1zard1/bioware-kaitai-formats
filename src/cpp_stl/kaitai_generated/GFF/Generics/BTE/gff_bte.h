...
class gff_bte_t : public kaitai::kstruct {

public:

    gff_bte_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_bte_t* p__root = 0);
...
public:
    ...
    gff_bte_t* _root() const { return m__root; }
