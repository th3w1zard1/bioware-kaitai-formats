...
class gff_bts_t : public kaitai::kstruct {

public:

    gff_bts_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gff_bts_t* p__root = 0);
...
public:
    ...
    gff_bts_t* _root() const { return m__root; }
