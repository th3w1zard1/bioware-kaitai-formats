...
da2s_t::da2s_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, da2s_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
...
void da2s_t::_read() {
    ...
    if (!(m_signature == std::string("DA2S"))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("DA2S"), m_signature, m__io, std::string("/seq/0"));
    }
...
da2s_t::length_prefixed_string_t::length_prefixed_string_t(kaitai::kstream* p__io, da2s_t* p__parent, da2s_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
...
void da2s_t::length_prefixed_string_t::_read() {
...
da2s_t::length_prefixed_string_t::~length_prefixed_string_t() {
    _clean_up();
}

void da2s_t::length_prefixed_string_t::_clean_up() {
}

std::string da2s_t::length_prefixed_string_t::value_trimmed() {
    if (f_value_trimmed)
