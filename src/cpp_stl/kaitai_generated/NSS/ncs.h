 ...
 * \sa https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ncs/io_ncs.py#L60-L90 PyKotor — compiled script load path
 ...
 * \sa https://github.com/OpenKotOR/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/formats/ncs/ncs_data.py#L69-L140 PyKotor — NCSByteCode / NCSInstructionQualifier (shared .ksy enums)
 */

class ncs_t : public kaitai::kstruct {

public:
    class instruction_t;

    ncs_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, ncs_t* p__root = 0);
...
public:
    ...
    public:
        ...
        instruction_t(kaitai::kstream* p__io, ncs_t* p__parent = 0, ncs_t* p__root = 0);
    ...
    private:
        bioware_ncs_common_t::ncs_bytecode_t m_opcode;
        bioware_ncs_common_t::ncs_instruction_qualifier_t m_qualifier;
    ...
    public:
         ...
         */
        bioware_ncs_common_t::ncs_bytecode_t opcode() const { return m_opcode; }
         ...
         */
        bioware_ncs_common_t::ncs_instruction_qualifier_t qualifier() const { return m_qualifier; }
         ...
         */
        std::vector<uint8_t>* arguments() const { return m_arguments; }
        ncs_t* _root() const { return m__root; }
        ncs_t* _parent() const { return m__parent; }
    };
