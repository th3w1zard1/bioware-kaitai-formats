...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffCam : KaitaiStruct
    {
        public static GffCam FromFile(string fileName)
        {
            return new GffCam(new KaitaiStream(fileName));
        }

        public GffCam(KaitaiStream p__io, KaitaiStruct p__parent = null, GffCam p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffCam M_Root { get { return m_root; } }
