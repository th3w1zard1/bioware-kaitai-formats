...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffQst : KaitaiStruct
    {
        public static GffQst FromFile(string fileName)
        {
            return new GffQst(new KaitaiStream(fileName));
        }

        public GffQst(KaitaiStream p__io, KaitaiStruct p__parent = null, GffQst p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffQst M_Root { get { return m_root; } }
