...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffRes : KaitaiStruct
    {
        public static GffRes FromFile(string fileName)
        {
            return new GffRes(new KaitaiStream(fileName));
        }

        public GffRes(KaitaiStream p__io, KaitaiStruct p__parent = null, GffRes p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffRes M_Root { get { return m_root; } }
