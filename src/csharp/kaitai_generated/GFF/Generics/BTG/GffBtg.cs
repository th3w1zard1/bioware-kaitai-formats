...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBtg : KaitaiStruct
    {
        public static GffBtg FromFile(string fileName)
        {
            return new GffBtg(new KaitaiStream(fileName));
        }

        public GffBtg(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBtg p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBtg M_Root { get { return m_root; } }
