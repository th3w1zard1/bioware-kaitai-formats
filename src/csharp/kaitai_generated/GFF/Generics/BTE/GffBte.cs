...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBte : KaitaiStruct
    {
        public static GffBte FromFile(string fileName)
        {
            return new GffBte(new KaitaiStream(fileName));
        }

        public GffBte(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBte p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBte M_Root { get { return m_root; } }
