...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffItp : KaitaiStruct
    {
        public static GffItp FromFile(string fileName)
        {
            return new GffItp(new KaitaiStream(fileName));
        }

        public GffItp(KaitaiStream p__io, KaitaiStruct p__parent = null, GffItp p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffItp M_Root { get { return m_root; } }
