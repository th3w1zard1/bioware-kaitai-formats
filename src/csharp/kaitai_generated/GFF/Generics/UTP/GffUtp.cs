...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtp : KaitaiStruct
    {
        public static GffUtp FromFile(string fileName)
        {
            return new GffUtp(new KaitaiStream(fileName));
        }

        public GffUtp(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtp p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtp M_Root { get { return m_root; } }
