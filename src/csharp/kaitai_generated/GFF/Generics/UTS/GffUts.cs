...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUts : KaitaiStruct
    {
        public static GffUts FromFile(string fileName)
        {
            return new GffUts(new KaitaiStream(fileName));
        }

        public GffUts(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUts p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUts M_Root { get { return m_root; } }
