...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBtd : KaitaiStruct
    {
        public static GffBtd FromFile(string fileName)
        {
            return new GffBtd(new KaitaiStream(fileName));
        }

        public GffBtd(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBtd p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBtd M_Root { get { return m_root; } }
