...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBtc : KaitaiStruct
    {
        public static GffBtc FromFile(string fileName)
        {
            return new GffBtc(new KaitaiStream(fileName));
        }

        public GffBtc(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBtc p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBtc M_Root { get { return m_root; } }
