...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBti : KaitaiStruct
    {
        public static GffBti FromFile(string fileName)
        {
            return new GffBti(new KaitaiStream(fileName));
        }

        public GffBti(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBti p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBti M_Root { get { return m_root; } }
