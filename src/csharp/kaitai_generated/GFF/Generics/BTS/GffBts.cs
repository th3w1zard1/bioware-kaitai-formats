...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBts : KaitaiStruct
    {
        public static GffBts FromFile(string fileName)
        {
            return new GffBts(new KaitaiStream(fileName));
        }

        public GffBts(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBts p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBts M_Root { get { return m_root; } }
