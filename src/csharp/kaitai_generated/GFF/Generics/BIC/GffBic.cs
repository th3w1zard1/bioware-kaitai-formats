...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBic : KaitaiStruct
    {
        public static GffBic FromFile(string fileName)
        {
            return new GffBic(new KaitaiStream(fileName));
        }

        public GffBic(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBic p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBic M_Root { get { return m_root; } }
