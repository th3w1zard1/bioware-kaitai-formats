...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffCut : KaitaiStruct
    {
        public static GffCut FromFile(string fileName)
        {
            return new GffCut(new KaitaiStream(fileName));
        }

        public GffCut(KaitaiStream p__io, KaitaiStruct p__parent = null, GffCut p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffCut M_Root { get { return m_root; } }
