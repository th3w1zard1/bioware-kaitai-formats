...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffPtt : KaitaiStruct
    {
        public static GffPtt FromFile(string fileName)
        {
            return new GffPtt(new KaitaiStream(fileName));
        }

        public GffPtt(KaitaiStream p__io, KaitaiStruct p__parent = null, GffPtt p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffPtt M_Root { get { return m_root; } }
