...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffIfo : KaitaiStruct
    {
        public static GffIfo FromFile(string fileName)
        {
            return new GffIfo(new KaitaiStream(fileName));
        }

        public GffIfo(KaitaiStream p__io, KaitaiStruct p__parent = null, GffIfo p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffIfo M_Root { get { return m_root; } }
