...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtg : KaitaiStruct
    {
        public static GffUtg FromFile(string fileName)
        {
            return new GffUtg(new KaitaiStream(fileName));
        }

        public GffUtg(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtg p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtg M_Root { get { return m_root; } }
