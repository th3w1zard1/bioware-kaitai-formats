...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffGic : KaitaiStruct
    {
        public static GffGic FromFile(string fileName)
        {
            return new GffGic(new KaitaiStream(fileName));
        }

        public GffGic(KaitaiStream p__io, KaitaiStruct p__parent = null, GffGic p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffGic M_Root { get { return m_root; } }
