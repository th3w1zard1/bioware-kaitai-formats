...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffDlg : KaitaiStruct
    {
        public static GffDlg FromFile(string fileName)
        {
            return new GffDlg(new KaitaiStream(fileName));
        }

        public GffDlg(KaitaiStream p__io, KaitaiStruct p__parent = null, GffDlg p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffDlg M_Root { get { return m_root; } }
