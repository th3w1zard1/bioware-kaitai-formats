...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffAre : KaitaiStruct
    {
        public static GffAre FromFile(string fileName)
        {
            return new GffAre(new KaitaiStream(fileName));
        }

        public GffAre(KaitaiStream p__io, KaitaiStruct p__parent = null, GffAre p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffAre M_Root { get { return m_root; } }
