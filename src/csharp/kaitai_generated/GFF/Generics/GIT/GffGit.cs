...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffGit : KaitaiStruct
    {
        public static GffGit FromFile(string fileName)
        {
            return new GffGit(new KaitaiStream(fileName));
        }

        public GffGit(KaitaiStream p__io, KaitaiStruct p__parent = null, GffGit p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffGit M_Root { get { return m_root; } }
