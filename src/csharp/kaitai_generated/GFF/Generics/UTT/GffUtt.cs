...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtt : KaitaiStruct
    {
        public static GffUtt FromFile(string fileName)
        {
            return new GffUtt(new KaitaiStream(fileName));
        }

        public GffUtt(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtt p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtt M_Root { get { return m_root; } }
