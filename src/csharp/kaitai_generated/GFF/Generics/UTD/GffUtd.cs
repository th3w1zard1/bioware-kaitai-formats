...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtd : KaitaiStruct
    {
        public static GffUtd FromFile(string fileName)
        {
            return new GffUtd(new KaitaiStream(fileName));
        }

        public GffUtd(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtd p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtd M_Root { get { return m_root; } }
