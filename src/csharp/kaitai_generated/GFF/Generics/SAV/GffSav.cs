...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffSav : KaitaiStruct
    {
        public static GffSav FromFile(string fileName)
        {
            return new GffSav(new KaitaiStream(fileName));
        }

        public GffSav(KaitaiStream p__io, KaitaiStruct p__parent = null, GffSav p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffSav M_Root { get { return m_root; } }
