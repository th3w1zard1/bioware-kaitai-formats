...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffQdb : KaitaiStruct
    {
        public static GffQdb FromFile(string fileName)
        {
            return new GffQdb(new KaitaiStream(fileName));
        }

        public GffQdb(KaitaiStream p__io, KaitaiStruct p__parent = null, GffQdb p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffQdb M_Root { get { return m_root; } }
