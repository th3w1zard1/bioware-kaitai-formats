...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBtt : KaitaiStruct
    {
        public static GffBtt FromFile(string fileName)
        {
            return new GffBtt(new KaitaiStream(fileName));
        }

        public GffBtt(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBtt p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBtt M_Root { get { return m_root; } }
