...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUti : KaitaiStruct
    {
        public static GffUti FromFile(string fileName)
        {
            return new GffUti(new KaitaiStream(fileName));
        }

        public GffUti(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUti p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUti M_Root { get { return m_root; } }
