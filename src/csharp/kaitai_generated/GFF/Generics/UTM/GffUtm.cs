...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtm : KaitaiStruct
    {
        public static GffUtm FromFile(string fileName)
        {
            return new GffUtm(new KaitaiStream(fileName));
        }

        public GffUtm(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtm p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtm M_Root { get { return m_root; } }
