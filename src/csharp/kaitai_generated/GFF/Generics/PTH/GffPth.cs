...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffPth : KaitaiStruct
    {
        public static GffPth FromFile(string fileName)
        {
            return new GffPth(new KaitaiStream(fileName));
        }

        public GffPth(KaitaiStream p__io, KaitaiStruct p__parent = null, GffPth p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffPth M_Root { get { return m_root; } }
