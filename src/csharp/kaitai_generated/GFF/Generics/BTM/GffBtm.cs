...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffBtm : KaitaiStruct
    {
        public static GffBtm FromFile(string fileName)
        {
            return new GffBtm(new KaitaiStream(fileName));
        }

        public GffBtm(KaitaiStream p__io, KaitaiStruct p__parent = null, GffBtm p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffBtm M_Root { get { return m_root; } }
