...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffFac : KaitaiStruct
    {
        public static GffFac FromFile(string fileName)
        {
            return new GffFac(new KaitaiStream(fileName));
        }

        public GffFac(KaitaiStream p__io, KaitaiStruct p__parent = null, GffFac p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffFac M_Root { get { return m_root; } }
