...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffSet : KaitaiStruct
    {
        public static GffSet FromFile(string fileName)
        {
            return new GffSet(new KaitaiStream(fileName));
        }

        public GffSet(KaitaiStream p__io, KaitaiStruct p__parent = null, GffSet p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffSet M_Root { get { return m_root; } }
