...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUtc : KaitaiStruct
    {
        public static GffUtc FromFile(string fileName)
        {
            return new GffUtc(new KaitaiStream(fileName));
        }

        public GffUtc(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUtc p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUtc M_Root { get { return m_root; } }
