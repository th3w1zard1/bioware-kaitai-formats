...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffJrl : KaitaiStruct
    {
        public static GffJrl FromFile(string fileName)
        {
            return new GffJrl(new KaitaiStream(fileName));
        }

        public GffJrl(KaitaiStream p__io, KaitaiStruct p__parent = null, GffJrl p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffJrl M_Root { get { return m_root; } }
