...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffUte : KaitaiStruct
    {
        public static GffUte FromFile(string fileName)
        {
            return new GffUte(new KaitaiStream(fileName));
        }

        public GffUte(KaitaiStream p__io, KaitaiStruct p__parent = null, GffUte p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffUte M_Root { get { return m_root; } }
