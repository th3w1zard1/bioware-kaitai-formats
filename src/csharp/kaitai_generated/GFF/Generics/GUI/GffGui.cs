...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class GffGui : KaitaiStruct
    {
        public static GffGui FromFile(string fileName)
        {
            return new GffGui(new KaitaiStream(fileName));
        }

        public GffGui(KaitaiStream p__io, KaitaiStruct p__parent = null, GffGui p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public GffGui M_Root { get { return m_root; } }
